 ...
 * Type: com.solarwars.entities.MarkerNode
 * 
...
public class MarkerNode extends Node {
    ...
    protected ColorRGBA start = ColorRGBA.Orange.clone();
    protected ColorRGBA end = ColorRGBA.White.clone();
    protected ColorRGBA currentFadeColor = start.clone();
    ...
    protected ColorRGBA rangeColor = ColorRGBA.White.clone();
    ...
    protected void updateRange(float tpf) {
    ...
    protected void updateScaleFade(float tpf) {
        running += tpf;
    ...
    protected void updateColorFade(float tpf) {
        if (tick > 0.005f) {
            if (fadeDir) {
                // color
